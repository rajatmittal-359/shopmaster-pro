...
| G19 | **YouTube link as product video** (YouTube Data API / oEmbed, free) — seller pastes a link, we embed; ends the 7 MB Cloudinary clip limit and lets a long demo live on their channel. Found in the 13 Sep category sweep | ✅ | — | VideoSlot accepts a YouTube URL; product page embeds it; schema `VideoObject` | ☐ |
| G20 | **Maps Embed API** — the shop's map on Contact and on Charming Jewels' shop page; free, no quota, no card | ✅ | — | iframe on /contact and /shop/[slug] when the seller has a pickup address | ☐ |
