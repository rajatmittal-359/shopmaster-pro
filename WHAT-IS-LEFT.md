...
| G9 | Merchant promotions — coupons shown in Shopping results | ✅ | Promotions add-on added 13 Sep ✅ | live coupons → Merchant API `promotions` (insert/update on coupon save, expire on end date); build before cutover, when listings start getting impressions | ☐ Claude, pre-cutover |
