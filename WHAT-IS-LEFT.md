...
| 2.20 | **Market insights** — Merchant API `price_competitiveness_product_view` + `best_sellers_product_cluster_view` → seller Grow page ("aapka daam market se X% upar", "is hafte category me top") + admin Google page | §3b C, decided 13 Sep | **Rajat: enable Market insights in Merchant Center** (API says "not enabled for account 5849184820"; Analytics → Best sellers → accept) |
