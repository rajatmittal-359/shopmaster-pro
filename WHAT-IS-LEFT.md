...
| 2.23 | **Assistant evals + AI Gateway** — 40-question set graded nightly by Gemini, trend on /admin/ask; all AI calls through Cloudflare AI Gateway (cost/cache/logs) | §3b E, decided 13 Sep | Rajat: create AI Gateway in Cloudflare dashboard (1 min, link when we get there) |
