...
export default function PricingPage() {
  return (
    <>
      <PolicyHeading title="Pricing" />

      <Section title="Currency">
        <p>
          Every price on this site is in <strong>Indian Rupees (INR)</strong> and
          includes all applicable taxes. We do not sell in other currencies.
        </p>
      </Section>

      <Section title="What the product price covers">
        <p>
          The price shown on a product is the price of that item. Where a higher
          price is shown struck through beside it, that is the seller&rsquo;s
          stated maximum retail price and the saving is the difference between
          the two.
        </p>
      </Section>
      ...
      <Section title="Delivery">
        <p>
          ...
          at checkout before you pay. It is around &#8377;{POLICY.shippingRate}{' '}
          for a typical small parcel within India, and some products are marked
          free delivery.
        </p>
      </Section>
      ...
      <Section title="Nothing is added later">
        <p>
          ...
          no handling charges, no convenience fees and no surcharge for paying by
      ...
      <Section title="Prices can change">
        <p>
          Prices and offers can change without notice, but the price you see when
          you place an order is the price you pay for that order.
        </p>
      </Section>
