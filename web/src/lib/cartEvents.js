 ...
 * this; the header count refreshes (`smp:counts`), the photo flies to the
 * bag when `from` (an element holding the product image) is given, and the
 * cart drawer opens with the fresh cart. Kept as a window event so a server-rendered card can
