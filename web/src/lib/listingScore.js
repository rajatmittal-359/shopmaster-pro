// Mirror of backend/utils/listingScore.js - keep the CHECKS identical. The
// form scores live from this; the server scores the saved product from that.
/**
