...
- "Delivered but not received": the courier's proof of delivery (photo/signature) or OTP decides; orders at or above ₹${RULES.otpDeliveryAbove} are delivered against an OTP. Without proof the benefit of the doubt is the customer's.
...
- GST: sellers below the threshold may sell without a GSTIN; neither the platform nor the house shop is GST-registered today, so no GST is charged on commission. When that changes, the settings page carries the GSTIN and invoices change with it.
