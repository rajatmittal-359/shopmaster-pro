        ...
        {wishlist.length === 0 && (
          <div className="text-center text-gray-500 mt-20">
            ...
            <button
              ...
              className="px-4 py-2 bg-brand-fill text-on-brand rounded-lg"
            >
              Continue Shopping
            </button>
          </div>
            ...
            {wishlist.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-brand-ink font-bold mt-1">
                    ₹{p.price}
                  </p>
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="flex-1 bg-brand-fill hover:bg-brand-fill-hover text-on-brand text-sm py-2 rounded-lg"
                    >
                      Add to Cart
                    </button>
