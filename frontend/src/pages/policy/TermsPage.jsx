    ...
    >
      ...
      <Section title="Who you are buying from">
        <p>
          ...
          {BUSINESS.addressLines.join(', ')}. Some items are sold by us and
          others by independent sellers. Every product page names its seller,
          and your contract for that item is with them.
        </p>
      </Section>
      ...
      <Section title="Your account">
        <p>
          ...
          details you give us &mdash; particularly the delivery address and
          phone number &mdash; must be accurate, because a courier cannot
          deliver to an address that does not exist.
        </p>
      </Section>
      ...
      <Section title="Orders">
        <p>
          ...
          email. We may decline an order and refund it in full if the item is
          out of stock, if the price was listed wrongly, or if we cannot deliver
      ...
      <Section title="Prices and payment">
        <p>
          ...
          taken through Razorpay; we never see or store your card details. Cash
          on delivery, where offered, is paid to the delivery agent.
        </p>
      </Section>
      ...
      <Section title="Delivery, cancellation and returns">
        <p>
          ...
          <Link to="/shipping-policy" className="text-brand-ink">
            shipping policy
          </Link>
          . You may cancel before dispatch, and return within{' '}
          {POLICY.returnDays} days of delivery, on the terms set out in the{' '}
          <Link to="/refund-policy" className="text-brand-ink">
      ...
      <Section title="Reviews and what you post">
        <p>
          Write honestly. We remove reviews that are abusive, that contain
          someone else&rsquo;s personal details, or that are not about the
          product.
        </p>
      </Section>
      ...
      <Section title="What we are responsible for">
        <p>
          ...
          couriers, weather or other events outside our control &mdash; though
          we will always tell you what has happened.
        </p>
      </Section>
      ...
      <Section title="Governing law">
        <p>
          ...
          Jaipur, Rajasthan have jurisdiction over any dispute.
        </p>
      </Section>
