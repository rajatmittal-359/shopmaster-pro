...
export default function PrivacyPage() {
  return (
    <PolicyLayout
      ...
      description="What Charming Jewels collects, why, who it is shared with, and your rights."
      path="/privacy"
    ...
    >
      ...
      <Section title="Why we hold it">
        <p>
          To take your order, deliver it, handle returns and refunds, answer
          your questions, and keep the records a business is required to keep.
        </p>
      </Section>
      ...
      <Section title="Who we share it with">
        ...
        <p>
          The site runs on Render, data is stored with MongoDB Atlas, and
          product images are hosted by Cloudinary. We never sell your data, and
      ...
      <Section title="How long we keep it">
        <p>
          Order records are kept for as long as the law requires business
          records to be kept. Ask us to close your account and we will delete
